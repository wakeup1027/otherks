...
MySQL - 5.1.62-community : Database - otherks
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`otherks` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `lottery_log`(`id`,`qiNum`,`Num`,`creantime`) values (1,'600055',135,'2018-12-14 19:44:13'),(2,'600056',356,'2018-12-14 19:54:12'),(3,'600057',144,'2018-12-14 20:04:12'),(4,'600058',156,'2018-12-14 20:14:12');
...
insert  into `opennum`(`id`,`openNum`,`spareNum`,`nowNum`) values (1,99,45,59);
...
insert  into `tasktimer`(`id`,`status`,`person`) values (1,1,0);
...
insert  into `timenumover`(`id`,`number`) values (1,600);
